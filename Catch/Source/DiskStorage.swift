...
//                throw c.cacheError(reason: .cannotCreateDirectory(path: path, error: error))
            ...
            expiration: StorageExpiration? = nil) throws
        {
            ...
            do {
                ...
                throw BotherError.cacheError(reason: .cannotConvertToData(object: value, error: error))
            }
            ...
            extendingExpiration: ExpirationExtending) throws -> T?
        {
            ...
            do {
                ...
                throw BotherError.cacheError(reason: .cannotLoadDataFromDisk(url: fileURL, error: error))
            }
        }
        ...
        func allFileURLs(for propertyKeys: [URLResourceKey]) throws -> [URL] {
            ...
            {
                throw BotherError.cacheError(reason: .fileEnumeratorCreationFailed(url: directoryURL))
            }

            guard let urls = directoryEnumerator.allObjects as? [URL] else {
                throw BotherError.cacheError(reason: .invalidFileEnumeratorContent(url: directoryURL))
            }
            return urls
        }
